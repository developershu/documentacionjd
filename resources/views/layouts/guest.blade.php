...
<head>
    ...
    <style>
        .bg-fondo {
            background-color: #003764; /* Color de fondo */
        }
        .bg- {
            background-color: #003764; /* Color de fondo del contenedor */
        }
    </style>
</head>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-fondo">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg- shadow overflow-hidden sm:rounded-lg">
             <div class="flex justify-center mb-4">
                <img src="https://github.com/developershu/proyectimages/blob/main/logo_documentacion.png?raw=true" alt="Logo de la Empresa" class="h-26 w-26">
            </div>
            {{ $slot }}
        </div>
    </div>
