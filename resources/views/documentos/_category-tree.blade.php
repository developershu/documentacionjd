                    ...
                    <div class="accordion-body">
                        ...
                        @else
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge rounded-pill bg-{{ $documento->estado === 'publicado' ? 'success' : 'secondary' }}">
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex justify-content-end align-items-center gap-2">
                                                        ...
                                                        <a href="{{ route('documentos.show', $documento) }}" class="btn btn-sm btn-outline-info">
                            ...
                            @if (!$categoria->subcategorias->isEmpty())
                                @include('documentos._category-tree', ['categorias' => $categoria->subcategorias])
                            @endif
                        @endif
                    </div>
                </div>
